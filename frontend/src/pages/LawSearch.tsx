...
import { searchLaws, getLawArticle, type LawSearchResult, type ArticleDetail } from '../api/admin';
...
export default function LawSearch() {
  ...
  return (
    <div className="space-y-6">
      ...
      <form onSubmit={handleSearch} className="bg-white rounded-xl shadow-sm border border-slate-100 p-5 space-y-4">
      ...
      {result && (
        <div className="space-y-5">
          <div className="bg-blue-50 border border-blue-200 rounded-xl p-5">
            ...
            <p className="text-slate-700 whitespace-pre-wrap text-sm leading-relaxed">{result.answer}</p>
          </div>
          ...
          {detail && (
            <div className="bg-white rounded-xl border border-blue-200 shadow-sm p-5">
              <h3 className="font-semibold text-slate-800 mb-2">{detail.law_name} {detail.article_no}</h3>
