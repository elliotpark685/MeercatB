      ...
      <div className="flex-1 flex items-center justify-center py-10">
        <div className="w-full max-w-sm px-4">
          ...
          >
            <div>
              ...
              <input
                ...
                placeholder="example@meerkat.com"
                className="w-full bg-[#121212] border border-[#2C2C2E] rounded-lg px-3 py-2.5 text-sm text-white placeholder-[#98989D] focus:outline-none focus:ring-2 focus:ring-[#00E5FF]/50 focus:border-[#00E5FF]/50 transition-all"
              />
            </div>
          ...
          <p className="text-center text-xs text-[#3A3A3C] mt-3">
            <Link to="/" className="hover:text-[#00E5FF]">
              MeerkatAI 홈으로
            </Link>
          </p>
          {/* <p className="text-center text-xs text-[#3A3A3C] mt-3">
