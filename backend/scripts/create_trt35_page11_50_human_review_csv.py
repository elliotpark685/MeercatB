"""Create a blank, geometry-only Human Golden review CSV for TRT35 page-11 50%."""
...
def main() -> None:
    ...
    if result.grid_status != "PASS" or len(result.cells) != 100:
        raise ValueError("50% Outrigger grid must resolve to exactly 100 cells before review")
