"""Capture an unfrozen OCR candidate for TRT35 page-15 8 m lattice jib / 0 deg."""
...
def main() -> None:
    ...
    if result.grid_status != "PASS" or len(result.cells) != 160:
        raise ValueError("page-15 lattice jib / 0 deg candidate requires a resolved 160-cell grid")
    capture = {
