"""Capture an unfrozen OCR candidate for TRT35 page-12 On Tires / max. 2 km/h."""
...
def main() -> None:
    ...
    if result.grid_status != "PASS" or len(result.cells) != 51:
        raise ValueError("page-12 On Tires / max. 2 km/h candidate requires a resolved 51-cell grid")
    capture = {
