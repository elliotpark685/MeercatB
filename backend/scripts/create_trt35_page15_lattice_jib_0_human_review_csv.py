"""Create a blank Human Golden CSV for TRT35 page-15 8 m lattice jib / 0 deg."""
...
def main() -> None:
    ...
    if result.grid_status != "PASS" or len(result.cells) != 160:
        raise ValueError("page-15 lattice jib / 0 deg grid must resolve to exactly 160 cells")
